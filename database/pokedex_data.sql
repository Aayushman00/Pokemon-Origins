...
INSERT INTO `Ability` VALUES (1,'Stench','Has a 10% chance of making target Pokémon flinch with each hit.'),(4,'Battle-armor','Protects against critical hits.'),(5,'Sturdy','Prevents being KOed from full HP, leaving 1 HP instead.  Protects against the one-hit KO moves regardless of HP.'),(6,'Damp','Prevents self destruct, explosion, and aftermath from working while the Pokémon is in battle.'),(7,'Limber','Prevents paralysis.'),(8,'Sand-veil','Increases evasion to 1.25× during a sandstorm.  Protects against sandstorm damage.'),(9,'Static','Has a 30% chance of paralyzing attacking Pokémon on contact.'),(10,'Volt-absorb','Absorbs electric moves, healing for 1/4 max HP.'),(11,'Water-absorb','Absorbs water moves, healing for 1/4 max HP.'),(12,'Oblivious','Prevents infatuation and protects against captivate.'),(13,'Cloud-nine','Negates all effects of weather, but does not prevent the weather itself.'),(14,'Compound-eyes','Increases moves\' accuracy to 1.3×.'),(15,'Insomnia','Prevents sleep.'),(17,'Immunity','Prevents poison.'),(18,'Flash-fire','Protects against fire moves.  Once one has been blocked, the Pokémon\'s own Fire moves inflict 1.5× damage until it leaves battle.'),(19,'Shield-dust','Protects against incoming moves\' extra effects.'),(20,'Own-tempo','Prevents confusion.'),(22,'Intimidate','Lowers opponents\' Attack one stage upon entering battle.'),(26,'Levitate','Evades ground moves.'),(27,'Effect-spore','Has a 30% chance of inflcting either paralysis, poison, or sleep on attacking Pokémon on contact.'),(28,'Synchronize','Copies burns, paralysis, and poison received onto the Pokémon that inflicted them.'),(29,'Clear-body','Prevents stats from being lowered by other Pokémon.'),(30,'Natural-cure','Cures any major status ailment upon switching out.'),(31,'Lightning-rod','Redirects single-target electric moves to this Pokémon where possible.  Absorbs Electric moves, raising Special Attack one stage.'),(32,'Serene-grace','Doubles the chance of moves\' extra effects occurring.'),(33,'Swift-swim','Doubles Speed during rain.'),(34,'Chlorophyll','Doubles Speed during strong sunlight.'),(35,'Illuminate','Doubles the wild encounter rate.'),(36,'Trace','Copies an opponent\'s ability upon entering battle.'),(38,'Poison-point','Has a 30% chance of poisoning attacking Pokémon on contact.'),(39,'Inner-focus','Prevents flinching.'),(41,'Water-veil','Prevents burns.'),(42,'Magnet-pull','Prevents steel opponents from fleeing or switching out.'),(43,'Soundproof','Protects against sound-based moves.'),(44,'Rain-dish','Heals for 1/16 max HP after each turn during rain.'),(46,'Pressure','Increases the PP cost of moves targetting the Pokémon by one.'),(47,'Thick-fat','Halves damage from fire and ice moves.'),(48,'Early-bird','Makes sleep pass twice as quickly.'),(49,'Flame-body','Has a 30% chance of burning attacking Pokémon on contact.'),(50,'Run-away','Ensures success fleeing from wild battles.'),(51,'Keen-eye','Prevents accuracy from being lowered.'),(52,'Hyper-cutter','Prevents Attack from being lowered by other Pokémon.'),(53,'Pickup','Picks up other Pokémon\'s used and Flung held items.  May also pick up an item after battle.'),(55,'Hustle','Strengthens physical moves to inflict 1.5× damage, but decreases their accuracy to 0.8×.'),(56,'Cute-charm','Has a 30% chance of infatuating attacking Pokémon on contact.'),(60,'Sticky-hold','Prevents a held item from being removed by other Pokémon.'),(61,'Shed-skin','Has a 33% chance of curing any major status ailment after each turn.'),(62,'Guts','Increases Attack to 1.5× with a major status ailment.'),(63,'Marvel-scale','Increases Defense to 1.5× with a major status ailment.'),(64,'Liquid-ooze','Damages opponents using leeching moves for as much as they would heal.'),(65,'Overgrow','Strengthens grass moves to inflict 1.5× damage at 1/3 max HP or less.'),(66,'Blaze','Strengthens fire moves to inflict 1.5× damage at 1/3 max HP or less.'),(67,'Torrent','Strengthens water moves to inflict 1.5× damage at 1/3 max HP or less.'),(68,'Swarm','Strengthens bug moves to inflict 1.5× damage at 1/3 max HP or less.'),(69,'Rock-head','Protects against recoil damage.'),(70,'Drought','Summons strong sunlight that lasts indefinitely upon entering battle.'),(71,'Arena-trap','Prevents opponents from fleeing or switching out.  Eluded by flying-types and Pokémon in the air.'),(72,'Vital-spirit','Prevents sleep.'),(75,'Shell-armor','Protects against critical hits.'),(77,'Tangled-feet','Doubles evasion when confused.'),(79,'Rivalry','Increases damage inflicted to 1.25× against Pokémon of the same gender, but decreases damage to 0.75× against the opposite gender.'),(80,'Steadfast','Raises Speed one stage upon flinching.'),(81,'Snow-cloak','Increases evasion to 1.25× during hail.  Protects against hail damage.'),(82,'Gluttony','Makes the Pokémon eat any held Berry triggered by low HP below 1/2 its max HP.'),(83,'Anger-point','Raises Attack to the maximum of six stages upon receiving a critical hit.'),(84,'Unburden','Doubles Speed upon using or losing a held item.'),(87,'Dry-skin','Causes 1/8 max HP in damage each turn during strong sunlight, but heals for 1/8 max HP during rain.  Increases damage from fire moves to 1.25×, but absorbs water moves, healing for 1/4 max HP.'),(88,'Download','Raises the attack stat corresponding to the opponents\' weaker defense one stage upon entering battle.'),(89,'Iron-fist','Strengthens punch-based moves to 1.2× their power.'),(91,'Adaptability','Increases the same-type attack bonus from 1.5× to 2×.'),(92,'Skill-link','Extends two-to-five-hit moves and triple kick to their full length every time.'),(93,'Hydration','Cures any major status ailment after each turn during rain.'),(94,'Solar-power','Increases Special Attack to 1.5× but costs 1/8 max HP after each turn during strong sunlight.'),(95,'Quick-feet','Increases Speed to 1.5× with a major status ailment.'),(97,'Sniper','Strengthens critical hits to inflict 3× damage rather than 2×.'),(98,'Magic-guard','Protects against damage not directly caused by a move.'),(99,'No-guard','Ensures all moves used by and against the Pokémon hit.'),(101,'Technician','Strengthens moves of 60 base power or less to 1.5× their power.'),(102,'Leaf-guard','Protects against major status ailments during strong sunlight.'),(104,'Mold-breaker','Bypasses targets\' abilities if they could hinder or prevent a move.'),(106,'Aftermath','Damages the attacker for 1/4 its max HP when knocked out by a contact move.'),(107,'Anticipation','Notifies all trainers upon entering battle if an opponent has a super-effective move, self destruct, explosion, or a one-hit KO move.'),(108,'Forewarn','Reveals the opponents\' strongest move upon entering battle.'),(109,'Unaware','Ignores other Pokémon\'s stat modifiers for damage and accuracy calculation.'),(110,'Tinted-lens','Doubles damage inflicted with not-very-effective moves.'),(111,'Filter','Decreases damage taken from super-effective moves by 1/4.'),(113,'Scrappy','Lets the Pokémon\'s normal and fighting moves hit ghost Pokémon.'),(115,'Ice-body','Heals for 1/16 max HP after each turn during hail.  Protects against hail damage.'),(119,'Frisk','Reveals an opponent\'s held item upon entering battle.'),(120,'Reckless','Strengthens recoil moves to 1.2× their power.'),(125,'Sheer-force','Strengthens moves with extra effects to 1.3× their power, but prevents their extra effects.'),(127,'Unnerve','Prevents opposing Pokémon from eating held Berries.'),(128,'Defiant','Raises Attack two stages upon having any stat lowered.'),(130,'Cursed-body','Has a 30% chance of Disabling any move that hits the Pokémon.'),(131,'Healer','Has a 30% chance of curing each adjacent ally of any major status ailment after each turn.'),(132,'Friend-guard','Decreases all direct damage taken by friendly Pokémon to 0.75×.'),(133,'Weak-armor','Raises Speed and lowers Defense by one stage each upon being hit by a physical move.'),(136,'Multiscale','Halves damage taken from full HP.'),(139,'Harvest','Has a 50% chance of restoring a used Berry after each turn if the Pokémon has held no items in the meantime.'),(142,'Overcoat','Protects against damage from weather.'),(143,'Poison-touch','Has a 30% chance of poisoning target Pokémon upon contact.'),(144,'Regenerator','Heals for 1/3 max HP upon switching out.'),(145,'Big-pecks','Protects against Defense drops.'),(146,'Sand-rush','Doubles Speed during a sandstorm.  Protects against sandstorm damage.'),(147,'Wonder-skin','Lowers incoming non-damaging moves\' base accuracy to exactly 50%.'),(148,'Analytic','Strengthens moves to 1.3× their power when moving last.'),(150,'Imposter','Transforms upon entering battle.'),(151,'Infiltrator','Bypasses light screen, reflect, and safeguard.'),(153,'Moxie','Raises Attack one stage upon KOing a Pokémon.'),(154,'Justified','Raises Attack one stage upon taking damage from a dark move.'),(155,'Rattled','Raises Speed one stage upon being hit by a dark, ghost, or bug move.'),(159,'Sand-force','Strengthens rock, ground, and steel moves to 1.3× their power during a sandstorm.  Protects against sandstorm damage.'),(172,'Competitive','Raises Special Attack by two stages upon having any stat lowered.');
...
INSERT INTO `pokemon_species` VALUES (1,'Seed Pokémon','A strange seed was planted on its back at birth. The plant sprouts and grows with this POKéMON.'),(2,'Seed Pokémon','When the bulb on its back grows large, it appears to lose the ability to stand on its hind legs.'),(3,'Seed Pokémon','The plant blooms when it is absorbing solar energy. It stays on the move to seek sunlight.'),(4,'Lizard Pokémon','Obviously prefers hot places. When it rains, steam is said to spout from the tip of its tail.'),(5,'Flame Pokémon','When it swings its burning tail, it elevates the temperature to unbearably high levels.'),(6,'Flame Pokémon','Spits fire that is hot enough to melt boulders. Known to cause forest fires unintentionally.'),(7,'Tiny Turtle Pokémon','After birth, its back swells and hardens into a shell. Powerfully sprays foam from its mouth.'),(8,'Turtle Pokémon','Often hides in water to stalk unwary prey. For swimming fast, it moves its ears to maintain balance.'),(9,'Shellfish Pokémon','A brutal POKéMON with pressurized water jets on its shell. They are used for high speed tackles.'),(10,'Worm Pokémon','Its short feet are tipped with suction pads that enable it to tirelessly climb slopes and walls.'),(11,'Cocoon Pokémon','This POKéMON is vulnerable to attack while its shell is soft, exposing its weak and tender body.'),(12,'Butterfly Pokémon','In battle, it flaps its wings at high speed to release highly toxic dust into the air.'),(13,'Hairy Bug Pokémon','Often found in forests, eating leaves. It has a sharp venomous stinger on its head.'),(14,'Cocoon Pokémon','Almost incapable of moving, this POKéMON can only harden its shell to protect itself from predators.'),(15,'Poison Bee Pokémon','It has three poisonous stingers on its forelegs and its tail. They are used to jab its enemy repeatedly.'),(16,'Tiny Bird Pokémon','A common sight in forests and woods. It flaps its wings at ground level to kick up blinding sand.'),(17,'Bird Pokémon','Very protective of its sprawling territorial area, this POKéMON will fiercely peck at any intruder.'),(18,'Bird Pokémon','When hunting, it skims the surface of water at high speed to pick off unwary prey such as MAGIKARP.'),(19,'Mouse Pokémon','Bites anything when it attacks. Small and very quick, it is a common sight in many places.'),(20,'Mouse Pokémon','It uses its whis┬¡ kers to maintain its balance. It apparently slows down if they are cut off.'),(21,'Tiny Bird Pokémon','It flaps its small wings busily to fly. Using its beak, it searches in grass for prey.'),(22,'Beak Pokémon','With its huge and magnificent wings, it can keep aloft without ever having to land for rest.'),(23,'Snake Pokémon','Moves silently and stealthily. Eats the eggs of birds, such as PIDGEY and SPEAROW, whole.'),(24,'Cobra Pokémon','It is rumored that the ferocious warning markings on its belly differ from area to area.'),(25,'Mouse Pokémon','When several of these POKéMON gather, their electricity could build and cause lightning storms.'),(26,'Mouse Pokémon','Its long tail serves as a ground to protect itself from its own high-voltage power.'),(27,'Mouse Pokémon','Burrows deep underground in arid locations far from water. It only emerges to hunt for food.'),(28,'Mouse Pokémon','Curls up into a spiny ball when threatened. It can roll while curled up to attack or escape.'),(29,'Poison Pin Pokémon','Although small, its venomous barbs render this POKéMON dangerous. The female has smaller horns.'),(30,'Poison Pin Pokémon','The female\'s horn develops slowly. Prefers physical attacks such as clawing and biting.'),(31,'Drill Pokémon','Its hard scales provide strong protection. It uses its hefty bulk to execute powerful moves.'),(32,'Poison Pin Pokémon','Stiffens its ears to sense danger. The larger its horns, the more powerful its secreted venom.'),(33,'Poison Pin Pokémon','An aggressive POKéMON that is quick to attack. The horn on its head secretes a powerful venom.'),(34,'Drill Pokémon','It uses its powerful tail in battle to smash, constrict, then break the prey\'s bones.'),(35,'Fairy Pokémon','Its magical and cute appeal has many admirers. It is rare and found only in certain areas.'),(36,'Fairy Pokémon','A timid fairy POKéMON that is rarely seen. It will run and hide the moment it senses people.'),(37,'Fox Pokémon','At the time of birth, it has just one tail. The tail splits from its tip as it grows older.'),(38,'Fox Pokémon','Very smart and very vengeful. Grabbing one of its many tails could result in a 1000-year curse.'),(39,'Balloon Pokémon','When its huge eyes light up, it sings a mysteriously soothing melody that lulls its enemies to sleep.'),(40,'Balloon Pokémon','The body is soft and rubbery. When angered, it will suck in air and inflate itself to an enormous size.'),(41,'Bat Pokémon','Forms colonies in perpetually dark places. Uses ultrasonic waves to identify and approach targets.'),(42,'Bat Pokémon','Once it strikes, it will not stop draining energy from the victim even if it gets too heavy to fly.'),(43,'Weed Pokémon','During the day, it keeps its face buried in the ground. At night, it wanders around sowing its seeds.'),(44,'Weed Pokémon','The fluid that oozes from its mouth isn\'t drool. It is a nectar that is used to attract prey.'),(45,'Flower Pokémon','It has the worldΓÇÖs largest petals. With every step, the petals shake out heavy clouds of toxic pollen.'),(46,'Mushroom Pokémon','Burrows to suck tree roots. The mushrooms on its back grow by draw┬¡ ing nutrients from the bug host.'),(47,'Mushroom Pokémon','A host-parasite pair in which the parasite mushroom has taken over the host bug. Prefers damp places.'),(48,'Insect Pokémon','Lives in the shadows of tall trees where it eats insects. It is attracted by light at night.'),(49,'Poison Moth Pokémon','The dustlike scales covering its wings are color-coded to indicate the kinds of poison it has.'),(50,'Mole Pokémon','Lives about one yard underground where it feeds on plant roots. It sometimes appears above ground.'),(51,'Mole Pokémon','A team of DIGLETT triplets. It triggers huge earthquakes by burrowing 60 miles underground.'),(52,'Scratch Cat Pokémon','It washes its face regularly to keep the coin on its forehead spotless. It doesnΓÇÖt get along with Galarian Meowth.'),(53,'Classy Cat Pokémon','Although its fur has many admirers, it is tough to raise as a pet because of its fickle meanness.'),(54,'Duck Pokémon','While lulling its enemies with its vacant look, this wily POKéMON will use psychokinetic powers.'),(55,'Duck Pokémon','Often seen swim┬¡ ming elegantly by lake shores. It is often mistaken for the Japanese monster, Kappa.'),(56,'Pig Monkey Pokémon','Extremely quick to anger. It could be docile one moment then thrashing away the next instant.'),(57,'Pig Monkey Pokémon','Always furious and tenacious to boot. It will not abandon chasing its quarry until it is caught.'),(58,'Puppy Pokémon','Very protective of its territory. It will bark and bite to repel intruders from its space.'),(59,'Legendary Pokémon','A POKéMON that has been admired since the past for its beauty. It runs agilely as if on wings.'),(60,'Tadpole Pokémon','Its newly grown legs prevent it from running. It appears to prefer swimming than trying to stand.'),(61,'Tadpole Pokémon','Capable of living in or out of water. When out of water, it sweats to keep its body slimy.'),(62,'Tadpole Pokémon','An adept swimmer at both the front crawl and breast stroke. Easily overtakes the best human swimmers.'),(63,'Psi Pokémon','Using its ability to read minds, it will identify impending danger and TELEPORT to safety.'),(64,'Psi Pokémon','It emits special alpha waves from its body that induce headaches just by being close by.'),(65,'Psi Pokémon','Its brain can out┬¡ perform a super┬¡ computer. Its intelligence quotient is said to be 5,000.'),(66,'Superpower Pokémon','Loves to build its muscles. It trains in all styles of martial arts to become even stronger.'),(67,'Superpower Pokémon','Its muscular body is so powerful, it must wear a power save belt to be able to regulate its motions.'),(68,'Superpower Pokémon','Using its heavy muscles, it throws powerful punches that can send the victim clear over the horizon.'),(69,'Flower Pokémon','A carnivorous POKéMON that traps and eats bugs. It uses its root feet to soak up needed moisture.'),(70,'Flycatcher Pokémon','It spits out POISONPOWDER to immobilize the enemy and then finishes it with a spray of ACID.'),(71,'Flycatcher Pokémon','Said to live in huge colonies deep in jungles, although no one has ever returned from there.'),(72,'Jellyfish Pokémon','Drifts in shallow seas. Anglers who hook them by accident are often punished by its stinging acid.'),(73,'Jellyfish Pokémon','The tentacles are normally kept short. On hunts, they are extended to ensnare and immobilize prey.'),(74,'Rock Pokémon','Found in fields and mountains. Mistaking them for boulders, people often step or trip on them.'),(75,'Rock Pokémon','Rolls down slopes to move. It rolls over any obstacle without slowing or changing its direction.'),(76,'Megaton Pokémon','Its boulder-like body is extremely hard. It can easily withstand dynamite blasts without damage.'),(77,'Fire Horse Pokémon','Its hooves are 10 times harder than diamonds. It can trample anything completely flat in little time.'),(78,'Fire Horse Pokémon','Very competitive, this POKéMON will chase anything that moves fast in the hopes of racing it.'),(79,'Dopey Pokémon','Incredibly slow and dopey. It takes 5 seconds for it to feel pain when under attack.'),(80,'Hermit Crab Pokémon','The SHELLDER that is latched onto SLOWPOKE\'s tail is said to feed on the host\'s left over scraps.'),(81,'Magnet Pokémon','Uses anti-gravity to stay suspended. Appears without warning and uses THUNDER WAVE and similar moves.'),(82,'Magnet Pokémon','Formed by several MAGNEMITEs linked together. They frequently appear when sunspots flare up.'),(83,'Wild Duck Pokémon','The sprig of green onions it holds is its weapon. It is used much like a metal sword.'),(84,'Twin Bird Pokémon','A bird that makes up for its poor flying with its fast foot speed. Leaves giant footprints.'),(85,'Triple Bird Pokémon','Uses its three brains to execute complex plans. While two heads sleep, one head stays awake.'),(86,'Sea Lion Pokémon','The protruding horn on its head is very hard. It is used for bashing through thick ice.'),(87,'Sea Lion Pokémon','Stores thermal energy in its body. Swims at a steady 8 knots even in intensely cold waters.'),(88,'Sludge Pokémon','Appears in filthy areas. Thrives by sucking up polluted sludge that is pumped out of factories.'),(89,'Sludge Pokémon','Thickly covered with a filthy, vile sludge. It is so toxic, even its footprints contain poison.'),(90,'Bivalve Pokémon','Its hard shell repels any kind of attack. It is vulnerable only when its shell is open.'),(91,'Bivalve Pokémon','When attacked, it launches its horns in quick volleys. Its innards have never been seen.'),(92,'Gas Pokémon','Almost invisible, this gaseous POKéMON cloaks the target and puts it to sleep without notice.'),(93,'Gas Pokémon','Because of its ability to slip through block walls, it is said to be from an┬¡ other dimension.'),(94,'Shadow Pokémon','Under a full moon, this POKéMON likes to mimic the shadows of people and laugh at their fright.'),(95,'Rock Snake Pokémon','As it grows, the stone portions of its body harden to become similar to a diamond, but colored black.'),(96,'Hypnosis Pokémon','Puts enemies to sleep then eats their dreams. Occasionally gets sick from eating bad dreams.'),(97,'Hypnosis Pokémon','When it locks eyes with an enemy, it will use a mix of PSI moves such as HYPNOSIS and CONFUSION.'),(98,'River Crab Pokémon','Its pincers are not only powerful weapons, they are used for balance when walking sideways.'),(99,'Pincer Pokémon','The large pincer has 10000 hp of crushing power. However, its huge size makes it unwieldy to use.'),(100,'Ball Pokémon','Usually found in power plants. Easily mistaken for a POKé BALL, they have zapped many people.'),(101,'Ball Pokémon','It stores electric energy under very high pressure. It often explodes with little or no provocation.'),(102,'Egg Pokémon','Often mistaken for eggs. When disturbed, they quickly gather and attack in swarms.'),(103,'Coconut Pokémon','Legend has it that on rare occasions, one of its heads will drop off and continue on as an EXEGGCUTE.'),(104,'Lonely Pokémon','Because it never removes its skull helmet, no one has ever seen this POKéMON\'s real face.'),(105,'Bone Keeper Pokémon','The bone it holds is its key weapon. It throws the bone skillfully like a boomerang to KO targets.'),(106,'Kicking Pokémon','When in a hurry, its legs lengthen progressively. It runs smoothly with extra long, loping strides.'),(107,'Punching Pokémon','While apparently doing nothing, it fires punches in lightning fast volleys that are impossible to see.'),(108,'Licking Pokémon','Its tongue can be extended like a chameleon\'s. It leaves a tingling sensation when it licks enemies.'),(109,'Poison Gas Pokémon','Because it stores several kinds of toxic gases in its body, it is prone to exploding without warning.'),(110,'Poison Gas Pokémon','Where two kinds of poison gases meet, 2 KOFFINGs can fuse into a WEEZING over many years.'),(111,'Spikes Pokémon','A POKéMON with a one-track mind. Once it charges,  it won\'t stop running until it falls asleep.'),(112,'Drill Pokémon','Protected by an armor-like hide, it is capable of living in molten lava of 3,600 degrees.'),(113,'Egg Pokémon','A rare and elusive POKéMON that is said to bring happiness to those who manage to get it.'),(114,'Vine Pokémon','The whole body is swathed with wide vines that are similar to sea┬¡ weed. Its vines shake as it walks.'),(115,'Parent Pokémon','The infant rarely ventures out of its mother\'s protective pouch until it is 3 years old.'),(116,'Dragon Pokémon','Known to shoot down flying bugs with precision blasts of ink from the surface of the water.'),(117,'Dragon Pokémon','Capable of swim┬¡ ming backwards by rapidly flapping its wing-like pectoral fins and stout tail.'),(118,'Goldfish Pokémon','Its tail fin billows like an elegant ballroom dress, giving it the nickname of the Water Queen.'),(119,'Goldfish Pokémon','In the autumn spawning season, they can be seen swimming powerfully up rivers and creeks.'),(120,'Star Shape Pokémon','If its body is torn, it can grow back if the red core remains. The core flashes at midnight.'),(121,'Mysterious Pokémon','Its central core glows with the seven colors of the rainbow. Some people value the core as a gem.'),(122,'Barrier Pokémon','If interrupted while it is miming, it will slap around the offender with its broad hands.'),(123,'Mantis Pokémon','With ninja-like agility and speed, it can create the illusion that there is more than one.'),(124,'Human Shape Pokémon','It seductively wiggles its hips as it walks. It can cause people to dance in unison with it.'),(125,'Electric Pokémon','Normally found near power plants, they can wander away and cause major blackouts in cities.'),(126,'Spitfire Pokémon','Its body always burns with an orange glow that enables it to hide perfectly among flames.'),(127,'Stag Beetle Pokémon','If it fails to crush the victim in its pincers, it will swing it around and toss it hard.'),(128,'Wild Bull Pokémon','When it targets an enemy, it charges furiously while whipping its body with its long tails.'),(129,'Fish Pokémon','In the distant past, it was somewhat stronger than the horribly weak descendants that exist today.'),(130,'Atrocious Pokémon','Once it begins to rampage, a GYARADOS will burn everything down, even in a harsh storm.'),(131,'Transport Pokémon','A POKéMON that has been over┬¡ hunted almost to extinction. It can ferry people across the water.'),(132,'Transform Pokémon','Capable of copying an enemy\'s genetic code to instantly transform itself into a duplicate of the enemy.'),(133,'Evolution Pokémon','Its genetic code is irregular. It may mutate if it is exposed to radiation from element STONEs.'),(134,'Bubble Jet Pokémon','Lives close to water. Its long tail is ridged with a fin which is often mistaken for a mermaid\'s.'),(135,'Lightning Pokémon','It accumulates negative ions in the atmosphere to blast out 10000- volt lightning bolts.'),(136,'Flame Pokémon','When storing thermal energy in its body, its temperature could soar to over 1600 degrees.'),(137,'Virtual Pokémon','A POKéMON that consists entirely of programming code. Capable of moving freely in cyberspace.'),(138,'Spiral Pokémon','Although long extinct, in rare cases, it can be genetically resurrected from fossils.'),(139,'Spiral Pokémon','A prehistoric POKéMON that died out when its heavy shell made it impossible to catch prey.'),(140,'Shellfish Pokémon','A POKéMON that was resurrected from a fossil found in what was once the ocean floor eons ago.'),(141,'Shellfish Pokémon','Its sleek shape is perfect for swim┬¡ ming. It slashes prey with its claws and drains the body fluids.'),(142,'Fossil Pokémon','A Pokémon that roamed the skies in the dinosaur era. Its teeth are like saw blades.'),(143,'Sleeping Pokémon','Very lazy. Just eats and sleeps. As its rotund bulk builds, it becomes steadily more slothful.'),(144,'Freeze Pokémon','A legendary bird POKéMON that is said to appear to doomed people who are lost in icy mountains.'),(145,'Electric Pokémon','A legendary bird POKéMON that is said to appear from clouds while dropping enormous lightning bolts.'),(146,'Flame Pokémon','Known as the legendary bird of fire. Every flap of its wings creates a dazzling flash of flames.'),(147,'Dragon Pokémon','Long considered a mythical POKéMON until recently when a small colony was found living underwater.'),(148,'Dragon Pokémon','A mystical POKéMON that exudes a gentle aura. Has the ability to change climate conditions.'),(149,'Dragon Pokémon','An extremely rarely seen marine POKéMON. Its intelligence is said to match that of humans.'),(150,'Genetic Pokémon','It was created by a scientist after years of horrific gene splicing and DNA engineering experiments.'),(151,'New Species Pokémon','So rare that it is still said to be a mirage by many experts. Only a few people have seen it worldwide.');
